...
public class RetailVendorsFragment extends Fragment {
    ...
    private void loadVendors() {
        mDatabase.child("users").orderByChild("userType").equalTo("Retail Vendor")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot vendorSnapshot : snapshot.getChildren()) {
                            ...
                            vendor.setShopName(vendorSnapshot.child("shopName").getValue(String.class));
                            vendor.setOwnerName(vendorSnapshot.child("fullName").getValue(String.class));
